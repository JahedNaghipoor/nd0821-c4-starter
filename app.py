...
Date: December, 2021
This script is used to create the app Flask API
Pylint score: 10/10
"""
...
from diagnostics import outdated_packages_list, execution_time, \
    missing_percentage, dataframe_summary, model_predictions
